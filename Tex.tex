...
Its basic definition is $\sigma=w\cdot \nicefrac{F}{N_T}$ and its unity is $[\sigma]=\si{\m}^2=10^28$barn where F is the surface of the target and N the number of particles that are included in this area.
